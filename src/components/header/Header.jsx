  ...
  return (
    <header className="header">
      <div className="container">
        <div className="row">
          <div className="col d-flex flex-row justify-content-left align-items-center flex-grow-1">
            <a className="logo-anchor" href="#">
              <img className="logo-warm" src={Logo} alt="" />
              <img className="d-none d-md-inline-block" src={Logo1} alt="" />
            </a>
          </div>
          <div className="col d-flex justify-content-around align-items-center flex-grow-1">
            <nav className="navbar">
              <div>
                <ul className="navbar-nav d-flex flex-row justify-content-around">
                  <li className="nav-item mx-2 mx-md-2">
